import { Ray, RigidBody, World, Cuboid } from '@dimforge/rapier3d';
...
export class CharacterControls {
    ...
    constructor(model: THREE.Group,
        ...
        currentAction: string,
        ray: Ray, rigidBody: RigidBody, forwardRay: Ray) {
        this.model = model
        this.mixer = mixer
        ...
        this.camera = camera
        this.updateCameraTarget(new THREE.Vector3(26, 14, 22))
    }
    ...
    public update(world: World, delta: number, keysPressed: any) {
        ...
        if (translation.y < -4) {
            ...
            if (hit) {
                ...
                // console.log("Collider", hit.colliderHandle,  "hit at point", point);
                if(hit.colliderHandle == 1){
